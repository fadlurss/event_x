...
<section class="formulir" id="formulir">
        <div class="container">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <form enctype="multipart/form-data" action="<?= base_url()."home/addevent"; ?>" method="post">
                        <div class="form-group">
                            <div class="container">
                                <div class="form-group">
                                   <div class="row">
                               ...
                               <div class="form-group">
                                ...
                                <button class="btn btn-primary" id="submit" name="submit" role="button" value="Submit">Add Event</button>
                                    </div>
                            </div>
                        </form>
                </div>

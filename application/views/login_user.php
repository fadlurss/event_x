                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1>Welcome to <strong>Event X</strong></h1>
                            <div class="description">
                                <p>
                                    This is an event website made for you from Event X. 
                        ...
                        <div class="col-sm-5 col-sm-offset-6 form-box">
                            <div class="form-top">
                                <div class="form-top-left">
                                    <h1>Log in to Event X</h1>
                                    <p>Don't have an account? <a href="<?= base_url()."home/register"; ?>">Sign up</a></p>
                                </div>
                            </div>
